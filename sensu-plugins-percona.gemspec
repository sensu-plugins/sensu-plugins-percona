...
<<<<<<< HEAD
  ...
  s.description            = 'Sensu plugins for the Percona SQL server'
=======
  s.name                   = 'sensu-plugins-percona'
  s.version                = SensuPluginsPercona::VERSION
  s.authors                = ['Sensu Plugins and contributors']
>>>>>>> update repo
...
<<<<<<< HEAD
  ...
  s.summary                = 'Sensu plugins for the Percona SQL server'
